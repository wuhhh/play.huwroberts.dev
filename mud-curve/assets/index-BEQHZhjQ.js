...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Oi,depthTest:!1,depthWrite:!1})}function rf(){return new Ri({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ju(),fragmentShader:`
		...
		`,blending:Oi,depthTest:!1,depthWrite:!1})}function sf(){return new Ri({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ju(),fragmentShader:`
...
#define LOW_PRECISION`),e}function $x(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===ld?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===Sm?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===qi&&(e="SHADOWMAP_TYPE_VSM"),e}function qx(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Qs:case ea:e="ENVMAP_TYPE_CUBE";break;case Ml:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Kx(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case ea:e="ENVMAP_MODE_REFRACTION";break}return e}function Zx(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case cd:e="ENVMAP_BLENDING_MULTIPLY";break;case zm:e="ENVMAP_BLENDING_MIX";break;case km:e="ENVMAP_BLENDING_ADD";break}return e}function jx(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Jx(r,e,t,n){const i=r.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=$x(t),c=qx(t),u=Kx(t),h=Zx(t),f=jx(t),d=zx(t),g=kx(s),_=i.createProgram();let m,p,S=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Sa).join(`
`)),a=cu(a),a=_f(a,t),a=gf(a,t),o=cu(o),o=_f(o,t),o=gf(o,t),a=vf(a),o=vf(o),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`)+`
`+p);const y=S+m+a,v=S+p+o,C=df(i,i.VERTEX_SHADER,y),w=df(i,i.FRAGMENT_SHADER,v);i.attachShader(_,C),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(P){if(r.debug.checkShaderErrors){const N=i.getProgramInfoLog(_).trim(),B=i.getShaderInfoLog(C).trim(),X=i.getShaderInfoLog(w).trim();let q=!0,G=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,C,w);else{const W=mf(i,C,"vertex"),H=mf(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function BS(r){const e=document.createElement("style");e.innerHTML=r;const t=document.querySelector("head link[rel=stylesheet], head style");t?document.head.insertBefore(e,t):document.head.appendChild(e)}let yf=!1;class Qu{constructor({parent:e,autoPlace:t=e===void 0,container:n,width:i,title:s="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:l=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!yf&&o&&(BS(OS),yf=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=a}add(e,t,n,i,s){if(Object(n)===n)return new NS(this,e,t,n);const a=e[t];switch(typeof a){case"number":return new US(this,e,t,n,i,s);case"boolean":return new wS(this,e,t);case"string":return new FS(this,e,t);case"function":return new sc(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
...
#`));this.skipRendering=e===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(r)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(r,e=eo){this.fullscreenMaterial.depthBuffer=r,this.fullscreenMaterial.depthPacking=e;for(const t of this.effects)t.setDepthTexture(r,e)}render(r,e,t,n,i){for(const s of this.effects)s.update(r,e,n);if(!this.skipRendering||this.renderToScreen){const s=this.fullscreenMaterial;s.inputBuffer=e.texture,s.time+=n*this.timeScale,r.setRenderTarget(this.renderToScreen?null:t),r.render(this.scene,this.camera)}}setSize(r,e){this.fullscreenMaterial.setSize(r,e);for(const t of this.effects)t.setSize(r,e)}initialize(r,e,t){this.renderer=r;for(const n of this.effects)n.initialize(r,e,t);this.updateMaterial(),t!==void 0&&t!==ei&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const r of this.effects)r.removeEventListener("change",this.listener),r.dispose()}handleEvent(r){switch(r.type){case"change":this.recompile();break}}};class OM extends PM{constructor({distance:e=20,strength:t=.3}={}){super("CurveEffect",` 
      ...
      `,{blendFunction:it.NORMAL,uniforms:new Map([["uDistance",new wn(e)],["uStrength",new wn(t)]])})}}var Ja,li,yi,ci,ui,ji,_r,Ln,hi,gr,Ji,st,zd,kd,Hd,Vd,Gd,fu,du,Wd,pu,Ko,Xd,Yd,$d,mu;class BM{constructor(e,t={}){Hn(this,st);Hn(this,Ja);Hn(this,li);Hn(this,yi);Hn(this,ci);Hn(this,ui);Hn(this,ji);Hn(this,_r);Hn(this,Ln);Hn(this,hi);Hn(this,gr);Hn(this,Ji);cn(this,Ja,e),cn(this,li,{autoStart:!1,sceneSelector:"[data-scene]",assetSelector:"[data-scene-asset]",updateOnScroll:!1,showGui:!1,uniforms:{distance:0,strength:0},...t}),cn(this,yi,[]),cn(this,ci,[]),cn(this,ui,{width:window.innerWidth,height:window.innerHeight}),Ft(this,st,zd).call(this),Ft(this,st,Hd).call(this),Ft(this,st,Vd).call(this),Ft(this,st,Gd).call(this),Ft(this,st,Xd).call(this),ye(this,li).autoStart&&this.start()}initAll(){const e=document.querySelectorAll(ye(this,li).sceneSelector);cn(this,ci,Array.from(e)),ye(this,ci).forEach(t=>{this.initMesh(t)})}initMesh(e){ye(this,ci).find(a=>a===e)||ye(this,ci).push(e),ye(this,yi).find(a=>a.domElement===e)&&this.destroyMesh(existing);const t=Ft(this,st,fu).call(this,e),n={current:new Ai(new so(1,1),new qu),specs:t,domElement:e},i=e.querySelector(ye(this,li).assetSelector),s=i==null?void 0:i.tagName;if(i&&["VIDEO","IMG"].includes(s)){const a=i.currentSrc;if(a){const o=i.clientWidth/i.clientHeight;let l,c,u;s==="VIDEO"?(l=new O_(i),{videoWidth:c,videoHeight:u}=i,Ft(this,st,pu).call(this,n,l,c,u,o)):new G_().loadAsync(a).then(f=>{({naturalWidth:c,naturalHeight:u}=f.source.data),Ft(this,st,pu).call(this,n,f,c,u,o)})}}else e.hasAttribute("data-scene-fill")&&(n.current.material.color=new vt(e.dataset.sceneFill));Ft(this,st,du).call(this,n,...n.specs),ye(this,ji).add(n.current),ye(this,yi).push(n)}destroyAll(){cn(this,ci,[]),cn(this,yi,[]),ye(this,ji).clear(),ye(this,hi).renderLists.dispose()}destroyMesh(e){var n,i,s,a,o,l,c;this.sceneEls=Array.from(ye(this,ci)).filter(u=>u!==e);const t=ye(this,yi).find(u=>u.domElement===e);cn(this,yi,ye(this,yi).filter(u=>u.domElement!==e)),ye(this,ji).remove(t.current),(s=(i=(n=t.current)==null?void 0:n.material)==null?void 0:i.map)==null||s.dispose(),(o=(a=t.current)==null?void 0:a.geometry)==null||o.dispose(),(c=(l=t.current)==null?void 0:l.material)==null||c.dispose()}start(){Ft(this,st,mu).call(this)}}Ja=new WeakMap,li=new WeakMap,yi=new WeakMap,ci=new WeakMap,ui=new WeakMap,ji=new WeakMap,_r=new WeakMap,Ln=new WeakMap,hi=new WeakMap,gr=new WeakMap,Ji=new WeakMap,st=new WeakSet,zd=function(){cn(this,ji,new lu),cn(this,_r,new Qu),ye(this,_r).hide(),ye(this,li).showGui&&ye(this,_r).show()},kd=function(e){const t=window.innerWidth,n=window.innerHeight,i=t/n;let s,a,o,l;return i>=1?(s=-e,a=e,o=e/i,l=-e/i):(s=-e*i,a=e*i,o=e,l=-e),{left:s,right:a,top:o,bottom:l}},Hd=function(){const e=Ft(this,st,kd).call(this,10);cn(this,Ln,new Ld(e.left,e.right,e.top,e.bottom,.1,1e3)),ye(this,Ln).position.set(0,0,10),ye(this,ji).add(ye(this,Ln))},Vd=function(){cn(this,hi,new AS({canvas:ye(this,Ja),powerPreference:"high-performance",antialias:!1,stencil:!1,depth:!1,alpha:!0})),ye(this,hi).setSize(ye(this,ui).width,ye(this,ui).height),ye(this,hi).setPixelRatio(Math.min(window.devicePixelRatio,2))},Gd=function(){cn(this,gr,new qS(ye(this,hi))),ye(this,gr).addPass(new DM(ye(this,ji),ye(this,Ln))),cn(this,Ji,new OM),ye(this,gr).addPass(new FM(ye(this,Ln),ye(this,Ji))),ye(this,_r).add(ye(this,Ji).uniforms.get("uDistance"),"value").min(0).max(100).step(.01).name("Distance"),ye(this,_r).add(ye(this,Ji).uniforms.get("uStrength"),"value").min(0).max(1).step(.01).name("Strength"),ye(this,Ji).uniforms.get("uDistance").value=ye(this,li).uniforms.distance,ye(this,Ji).uniforms.get("uStrength").value=ye(this,li).uniforms.strength},fu=function(e){const t=e.getBoundingClientRect(),n={x:t.left+t.width/2,y:t.top+t.height/2+window.scrollY},i=n.x/window.innerWidth*2-1,s=-((n.y-window.scrollY)/window.innerHeight)*2+1,a=t.width/window.innerWidth*2+1,o=t.height/window.innerHeight*2+1,l=new $(i,s,0).unproject(ye(this,Ln)),{x:c,y:u}=l;return[c,u,a,o]},du=function(e,t,n,i,s){const{width:a,height:o}=Ft(this,st,Wd).call(this);e.current.position.x=t,e.current.position.y=n;const l=(h,f)=>h*(1-Math.abs(f))/2;let c=l(a,i),u=l(o,s);e.current.scale.x=c,e.current.scale.y=u},Wd=function(){const e=new rt;ye(this,hi).getSize(e);let t,n;if(ye(this,Ln).isOrthographicCamera)t=ye(this,Ln).right-ye(this,Ln).left,n=ye(this,Ln).top-ye(this,Ln).bottom;else throw new Error("Camera must be an OrthographicCamera");return{width:t,height:n}},pu=function(e,t,n,i,s){t.flipY=!1,t.colorSpace=It,t.wrapS=sl,t.repeat.x=-1;const a=n/i;s>a?(t.repeat.y=a/s,t.offset.y=(1-t.repeat.y)/2):s<a&&(t.repeat.x=s/a*-1,t.offset.x=(1-t.repeat.x)/2),e.current.material.map=t,e.current.material.transparent=!0,e.current.material.needsUpdate=!0,ye(this,hi).initTexture(t)},Ko=function(){ye(this,ci).length&&ye(this,ci).forEach(e=>{const t=ye(this,yi).find(n=>n.domElement===e);t&&(t.specs=Ft(this,st,fu).call(this,e),Ft(this,st,du).call(this,t,...t.specs))})},Xd=function(){window.addEventListener("resize",()=>Ft(this,st,Yd).call(this)),window.addEventListener("scroll",()=>Ft(this,st,$d).call(this))},Yd=function(){ye(this,ui).width=window.innerWidth,ye(this,ui).height=window.innerHeight,Ft(this,st,Ko).call(this),ye(this,hi).setSize(ye(this,ui).width,ye(this,ui).height),ye(this,hi).setPixelRatio(Math.min(window.devicePixelRatio,2)),ye(this,gr).setSize(ye(this,ui).width,ye(this,ui).height)},$d=function(){ye(this,li).updateOnScroll&&Ft(this,st,Ko).call(this)},mu=function(){ye(this,gr).render(),ye(this,li).updateOnScroll||Ft(this,st,Ko).call(this),window.requestAnimationFrame(()=>Ft(this,st,mu).call(this))};class zM{constructor(){document.querySelectorAll("a").forEach(t=>{t.addEventListener("click",n=>this.onClick(n))})}onClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href"),n=t.replace(window.location.origin,"");window.history.pushState(null,null,t),this.onNavigate(n)}async onNavigate(e){const t=new CustomEvent("navigate",{detail:{path:e}});window.dispatchEvent(t);const n=await fetch(e).then(c=>c.text()),s=new DOMParser().parseFromString(n,"text/html"),a=document.querySelector("#contents"),o=s.querySelector("#contents");a.innerHTML=o.innerHTML;const l=new CustomEvent("navigated",{detail:{path:e}});setTimeout(()=>{window.dispatchEvent(l)},10)}}function Ki(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function qd(r,e){r.prototype=Object.create(e.prototype),r.prototype.constructor=r,r.__proto__=e}/*!
 * GSAP 3.12.7
 * https://gsap.com
 *
